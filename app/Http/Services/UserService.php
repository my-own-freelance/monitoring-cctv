    ...
    public function dataTable($request)
    {
        ...
        $output = $data->map(function ($item) {
            ...
            if ($user->role == "superadmin") {
                ...
                $action_add_cctv = $item->role == "operator_cctv" ? "<a class='dropdown-item' onclick='return addCctv(\"{$item->id}\", \"{$item->username}\");' href='javascript:void(0)' title='Tambah CCTV'>Atur CCTV</a>" : "";
