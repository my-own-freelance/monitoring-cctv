...
@section('content')
    <div
        ...
        <h1 class="title fw-bold text-white mb-3">DASHBOARD CCTC MONITORING</h1>
        <p class="subtitle text-white op-7">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Aliquam quae error
            quasi aut</p>
    </div>
